...
donor_training=np.load(file="donor_training.npy")#replace with your file name for use
recipient_training=np.load(file="recipient_training.npy")#replace with your file name for use


y_train1=np.load(file="label.npy")#replace with your file name for use


donor_validation=np.load(file="donor_validation.npy")#replace with your file name for use
recipient_validation=np.load(file="recipient_validation.npy")#replace with your file name for use

y_val_reform=np.load(file="validation_label.npy")#replace with your file name for use


donor_testing=np.load(file="donor_testing.npy")#replace with your file name for use
recipient_testing=np.load(file="recipient_testing.npy")#replace with your file name for use

y_testing_reform=np.load(file="testing_label.npy")#replace with your file name for use
