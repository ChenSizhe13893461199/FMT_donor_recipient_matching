...
increased = data.Overall_Increased_Similarity; % Increased Similarity
dissimilarity = data.Overall_Microbiome_Dissimilarity; % Dissimilarity between donor pre-FMT recipient
