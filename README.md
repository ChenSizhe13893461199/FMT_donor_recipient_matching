...
**Notes: The name of each input feature for MOZAIC is available in "Input_Variable_Annotation.txt". The order of these feature corresponds precisely to the columns in the data matrices, arranged sequentially from left to right and top to bottom.**
